...
describe.skip('Route /user/:user/address => Method: POST', function () {
    let route = ''
    let cookie = ''
    let user = {}
...
describe.skip('Route /user/:user/order => Method: POST', function () {
    ...
    /**
     *  TODO:
     *  missing address id, total price paid, status_id, orders
     */
